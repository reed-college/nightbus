...
1. Make a virtual environment in python 3.6. The best way to do this is to install virtualenvwrapper and use the `mkvirtualenv` command. The proper command looks like this: `mkvirtualenv nightbus -p python3`. 
